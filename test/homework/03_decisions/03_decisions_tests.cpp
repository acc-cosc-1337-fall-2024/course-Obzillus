...
TEST_CASE("Verify get_letter_grade_using_if Function", "return correct letter grade"){
...
TEST_CASE("Verify get_letter_grade_using_switch Function", "return correct letter grade"){
